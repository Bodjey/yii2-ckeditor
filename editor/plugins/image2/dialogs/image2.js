...
CKEDITOR.dialog.add("image2", function(f) {
    ...
    function F() {
        ...
        }), n = !0) : n ? (t(!0), g.setValue(k), h.setValue(l), n = !1) : t(!0)
    }
    ...
    var D = /(^\s*(\d+)(px)?\s*$)|^$/i,
        ...
        E = H.getNatural,
        r, x, L, G, k, l, u, v, n, e, y, d, p, g, h, B, M = [{
            id: "src",
            type: "text",
            label: c.url,
            onKeyup: F,
            ...
            elements: [{
                ...
                children: [{
                    ...
                    setup: function(a) {
						...
						if ( a.hasClass( 'align-image-center' ) )
							this.setValue( 'center' );
						if ( a.hasClass( 'align-image-left' ) )
							this.setValue( 'left' );
						if ( a.hasClass( 'align-image-right' ) )
							this.setValue( 'right' );

                    },
                    commit: function(a) {
                        // a.setData("align", this.getValue())
						a.removeClass( 'align-image-center' );
						a.removeClass( 'align-image-left' );
						a.removeClass( 'align-image-right' );

						if ( this.getValue() && this.getValue() != 'none' )
							a.addClass( 'align-image-' + this.getValue() );
                    }
                }]
            }, {
                id: "hasCaption",
